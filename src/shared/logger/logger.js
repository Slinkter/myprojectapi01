...
const STYLES = {
  render:
    "background: #222; color: #bada55; font-weight: bold; padding: 2px 5px; border-radius: 3px;",
  state: "background: #1a365d; color: #bee3f8; padding: 2px 5px;",
  effect:
    "background: #2d3748; color: #cbd5e0; padding: 2px 5px; font-style: italic;",
  redux:
    "background: #44337a; color: #e9d8fd; padding: 2px 5px; font-weight: bold;",
  error:
    "background: #742a2a; color: #fff; padding: 2px 5px; font-weight: bold;",
...
export const log = {
  ...
  flow: (type) => {
    if (FLOW_ART[type]) {
      console.log(
        `%c${FLOW_ART[type]}`,
        "color: #48bb78; font-family: monospace;",
      );
    }
  },
