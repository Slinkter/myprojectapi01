...
*   **Estética Glassmorphism + Minimalismo Técnico**: Diseñado con glassmorphism puro (`backdrop-filter: blur(30px)`, fondos semi-transparentes, bordes sutiles). Sin decoraciones pesadas, la interfaz prioriza claridad, profundidad visual y un enfoque minimalista funcional usando la tipografía Inter.
