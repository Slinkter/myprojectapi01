...
const ErrorUserDetail = ({ error }) => (
  <div className="flex flex-col items-center py-24 gap-6">
    ...
    <div className="text-center space-y-2">
      <h3 className="text-2xl font-extrabold font-heading text-text">
        Error de Conexión
      </h3>
      <p className="text-red-500/90 font-medium max-w-sm">
        {error?.message ||
          "No pudimos encontrar el perfil de este desarrollador."}
      </p>
    </div>
...
const UserDetail = () => {
  ...
  if (isError) {
    return <ErrorUserDetail error={error} />;
  }
  ...
  return (
    ...
    >
      <div className="absolute top-1/4 left-1/2 -translate-x-1/2 w-96 h-96 bg-linear-to-tr from-accent/5 to-indigo-500/5 rounded-full blur-3xl pointer-events-none -z-10" />
